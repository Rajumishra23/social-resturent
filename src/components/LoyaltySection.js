...
<div className="flex flex-col md:flex-row w-full h-full">
  ...
  <div className="bg-orange-500 w-full md:w-1/2 flex items-center justify-center p-6 md:p-12">
    <div className="w-full max-w-5xl h-[500px] md:h-[650px]">
      <iframe
  ...
  <div className="bg-black w-full md:w-1/2 text-white p-6 md:p-16 flex flex-col justify-center">
    ...
    <button className="mt-8 bg-black border border-white text-white px-10 py-5 rounded-full font-semibold hover:bg-white hover:text-black transition text-xl">
      Explore Program
    </button>
  </div>
</div>
